<?php 
	...
	class Paysafe_Gateway_Init extends WC_Payment_Gateway {
		...
		public function form() {
			...
			?>
	         <input id="payment_method_cc" class="input-radio" name="mer_paysafe_payment_method" value="mer_paysafe_credit_card" data-order_button_text="" type="radio" checked="checked" onclick="paysafecc()">
            ...
            $i++;
	         ...
	         { ?>
	         <input id="payment_method_token" class="input-radio" name="mer_paysafe_payment_method" value="mer_paysafe_token" data-order_button_text="" type="radio" onclick="paysafetoken()">
 ...
 if(!empty($listcard)){
    ...
    ?>
  <tr><th><?php _e( 'Select', 'mer-paysafepayments-aim' ); ?></th><th><?php _e( 'Cards', 'mer-paysafepayments-aim' ); ?></th><th><?php _e( 'Date', 'mer-paysafepayments-aim' ); ?></th><th></th></tr>
	 <?php
	 $c=0;
   ...
   <input class="save_card_number" type="radio" name="<?php echo esc_attr( $this->id )."-token-number"; ?>" value='<?php echo esc_html( $cards[0]['paysafe_tokenno'] ); ?>'></td><td><?php echo esc_html( $cards[0]['paysafe_cardnum'] ); ?></td><td><?php echo esc_html( $cards[0]['paysafe_date_of_card_used'] ); ?></td></tr>
	 <?php 
	 $c++;
